...
import should.MatcherTools in T;
...
class Main {
	static function main() {
		...
		its('hogeee-5').val(123).should( not( beEqualTo(200) ) && T._( not ( beEqualTo(100) )));
		its('hogeee-6').val(123).should( beEqualTo(200) || T._( beEqualTo(123) ));
	}
}